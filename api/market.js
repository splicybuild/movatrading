const NON_EQUITIES=new Set(["GOLD","SILVER","OIL"]);
const NAMES={"LYG":"Lloyds Banking Group","NWG":"NatWest Group","SAN":"Banco Santander","UBS":"UBS Group","DB":"Deutsche Bank","RY":"Royal Bank of Canada","TD":"Toronto-Dominion Bank","BMO":"Bank of Montreal","BNS":"Bank of Nova Scotia","CM":"Canadian Imperial Bank of Commerce","MUFG":"Mitsubishi UFJ Financial Group","SMFG":"Sumitomo Mitsui Financial Group","MFG":"Mizuho Financial Group","ING":"ING Groep","BBVA":"Banco Bilbao Vizcaya Argentaria","ADBE":"Adobe","CSCO":"Cisco Systems","ORCL":"Oracle","QCOM":"Qualcomm","MU":"Micron Technology","AMAT":"Applied Materials","LRCX":"Lam Research","INTU":"Intuit","PANW":"Palo Alto Networks","CRWD":"CrowdStrike","PLTR":"Palantir Technologies","ARM":"Arm Holdings","INTC":"Intel","ADI":"Analog Devices","KLAC":"KLA","MCHP":"Microchip Technology","NXPI":"NXP Semiconductors","SNPS":"Synopsys","CDNS":"Cadence Design Systems","MRVL":"Marvell Technology","FTNT":"Fortinet","ADSK":"Autodesk","JPM":"JPMorgan Chase","BAC":"Bank of America","GS":"Goldman Sachs","C":"Citigroup","WFC":"Wells Fargo","MS":"Morgan Stanley","HSBC":"HSBC Holdings","BCS":"Barclays","PDD":"PDD Holdings (Temu)","BABA":"Alibaba Group (AliExpress)","JD":"JD.com","MELI":"MercadoLibre","EBAY":"eBay",
"NVDA":"NVIDIA","MSFT":"Microsoft","AAPL":"Apple","AMZN":"Amazon","META":"Meta Platforms","GOOGL":"Alphabet","TSLA":"Tesla","AVGO":"Broadcom","QQQ":"Invesco QQQ",
"AMD":"AMD","NEE":"NextEra Energy","SO":"Southern Company","DUK":"Duke Energy","AEP":"American Electric Power","SRE":"Sempra",
...
"BKNG":"Booking Holdings","MELI":"MercadoLibre","MAR":"Marriott","NFLX":"Netflix","TMUS":"T-Mobile US","WBD":"Warner Bros. Discovery",
    ...
    if(!NON_EQUITIES.has(symbol)&&fh){
      try{
        ...
        assets.push({
          ...
          openNative:num(q.o),previousCloseNative:num(q.pc),
          openGBP:fx!=null&&num(q.o)!=null?Number((num(q.o)*fx).toFixed(2)):null,
          previousCloseGBP:fx!=null&&num(q.pc)!=null?Number((num(q.pc)*fx).toFixed(2)):null,
          changePct,
    ...
    if(td){
      try{
        ...
        assets.push({
          ...
          type:symbol==="QQQ"?"etf":NON_EQUITIES.has(symbol)?"commodity":"stock",
          nativeCurrency:currency,priceNative:p,
          priceGBP:converted!=null?Number(converted.toFixed(2)):null,
          openNative:num(q.open),previousCloseNative:prev,
          openGBP:currency==="GBP"&&num(q.open)!=null?Number(num(q.open).toFixed(2)):(currency==="USD"&&fx!=null&&num(q.open)!=null?Number((num(q.open)*fx).toFixed(2)):null),
          previousCloseGBP:currency==="GBP"&&prev!=null?Number(prev.toFixed(2)):(currency==="USD"&&fx!=null&&prev!=null?Number((prev*fx).toFixed(2)):null),
