...
const COMPANY_FACT_OVERRIDES={
  "BCS":{founded:"1690",founders:["John Freame","Thomas Gould"],headquarters:"1 Churchill Place, Canary Wharf, London, United Kingdom"},
  "JPM":{founded:"2000",founders:["No single founder — JPMorgan Chase was formed by the merger of Chase Manhattan Bank and J.P. Morgan & Co.; major predecessor founders include Aaron Burr and J. Pierpont Morgan"],headquarters:"270 Park Avenue, New York City, New York, United States"},
  "NWG":{headquarters:"36 St Andrew Square, Edinburgh, United Kingdom"},
  "SAN":{headquarters:"Boadilla del Monte, Madrid, Spain"},
  "LYG":{headquarters:"London, United Kingdom"}
};
