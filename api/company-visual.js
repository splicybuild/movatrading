...
export default{async fetch(request){
  ...
  try{
    ...
    const pageLogo=bestPageLogo(html,finalUrl); const icon=bestIcon(html,finalUrl); const jsonLogos=jsonLdLogos(html,finalUrl);
    ...
    return Response.json({
      ...
      logo:pageLogo||jsonLogos[0]||icon||fallbackLogo,
      logoCandidates:[pageLogo,...jsonLogos,icon,fallbackLogo].filter(Boolean),
