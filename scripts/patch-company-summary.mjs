...
block=block
  .replace("fetchJson('/api/company-profile?ticker='+encodeURIComponent(k)+'&name='+encodeURIComponent(a.n),6500)","fetchJson('/api/company-history?rev=20260831c&ticker='+encodeURIComponent(k)+'&name='+encodeURIComponent(a.n),6500)")
...
console.log('Busted stale company-history cache and increased structured summary depth.');
